...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ( (zMovement != 0f || xMovement != 0f) )
        {
            ...
            //ORIGINAL      
            resultingNewPosition = new Vector3();
            resultingNewPosition.z = Camera.main.transform.forward.z * zMovement;
            resultingNewPosition.y = 0f;
            resultingNewPosition.x = Camera.main.transform.right.x * xMovement;
        ...
        else if ( (zMovement != 0f || xMovement != 0f) && (!stillMoving) )
        {
