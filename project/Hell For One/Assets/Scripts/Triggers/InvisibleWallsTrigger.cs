...
public class InvisibleWallsTrigger : MonoBehaviour
{
    ...
    // {
    //     GameEventsManager.OnBattleExit += OpenInvisibleWalls;
    //     GameEventsManager.OnBattleExit += DisableBossFlames;
    //     GameEventsManager.OnBattleExit += DisableWallsBoss;
    //     GameEventsManager.OnBattleExit += DisableFlameCircle;
    //     GameEventsManager.OnBattleExit += DisableFirewallMidBoss;
    //     GameEventsManager.OnBattleEnter += CloseInvisibleWalls;
    //     GameEventsManager.OnBattleEnter += EnableArenaWallMidBoss;
    //     GameEventsManager.OnBattleEnter += EnableFlameCircle;
    //     GameEventsManager.OnBattleEnter += EnableBossFlames;
    //     GameEventsManager.OnBattleEnter += EnableWallBoss;
    //     GameEventsManager.OnBattleEnter += EnableFirewallMidBoss;
    //     DisableNormalFlames();
    //     DisableBossFlames();
    // }
    //
